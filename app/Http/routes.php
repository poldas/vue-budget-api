...
$api->version('v1', function ($api) {
	...
	$api->group(['namespace' => 'Api\Controllers', 'middleware' => 'cors'], function ($api) {
		...
		$api->get('wydatki', 'WydatkiController@index');
		$api->post('wydatki', 'WydatkiController@store');
		$api->get('wydatki/{id}', 'WydatkiController@show');
		$api->delete('wydatki/{id}', 'WydatkiController@destroy');
		$api->put('wydatki/{id}', 'WydatkiController@update');
